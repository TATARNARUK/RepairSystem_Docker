              ...
              <form action="" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="email" name="username" class="form-control" required placeholder="อีเมล">
                    </div>
                  </div>
  ...
  try {
    ...
    if ($stmtMemberDetail->rowCount() == 1) {
      ...
      echo '<script>
                    ...
                    swal({
                        title: "username ซ้ำ !!",
                        text: "กรุณาเพื่มข้อมูลใหม่อีกครั้ง",
                        type: "error"
                    }, function() {
      ...
      $stmtInserMember->bindParam(':password', $password, PDO::PARAM_STR);
      ...
      $stmtInserMember->bindParam(':m_level', $m_level, PDO::PARAM_STR);
